  ...
  return (
    <svg width="240" height="240" viewBox="0 0 240 240" style={{ overflow: "visible" }}>
      ...
      {Array.from({ length: 24 }).map((_, i) => {
        ...
        return (
          <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke="#E8F5F1" strokeWidth="1" opacity="0.5" />
        );
      })}
    </svg>
  );
          ...
          <div style={styles.ringSection}>
            ...
            <div style={styles.scoreMeta}>
              ...
              <div style={styles.percentileBox}>
                <div style={styles.percentileValue}>Top 15%</div>
                ...
                {[
                  ...
                  return (
                    <div key={band.label} style={{ textAlign: "center" }}>
                      <div style={{ ...styles.ratingBar, background: active ? "#1D9E75" : "#E8F5F1" }} />
                      <div style={{ ...styles.ratingBandLabel, color: active ? "#1D9E75" : "#A0ADB8", fontWeight: active ? "700" : "400" }}>
                        {band.label}
                      </div>
                    </div>
                  );
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                boxShadow: h.current ? "0 4px 16px rgba(29,158,117,0.35)" : "0 2px 8px rgba(0,0,0,0.06)",
              }}
            >
...
const styles = {
  ...
  scoreLabel: { fontSize: "13px", color: "#6B7A8D", marginTop: "4px", fontWeight: "500" },
  scoreMax: { fontSize: "11px", color: "#A0ADB8", marginTop: "2px" },
  ...
  gainArrow: { fontSize: "18px", color: "#1D9E75", fontWeight: "700" },
  gainText: { fontSize: "15px", fontWeight: "700", color: "#1D9E75" },
  prevScore: { fontSize: "12px", color: "#A0ADB8", marginBottom: "20px" },
  percentileBox: { background: "#F7F9FC", borderRadius: "12px", padding: "16px 20px", marginBottom: "20px" },
  percentileValue: { fontSize: "24px", fontWeight: "700", color: "#1A2332" },
  percentileLabel: { fontSize: "12px", color: "#6B7A8D", marginTop: "2px" },
  ratingRow: { display: "flex", gap: "6px", alignItems: "flex-end" },
  ratingBar: { height: "8px", borderRadius: "4px", width: "42px", marginBottom: "4px", transition: "background 0.3s" },
  ratingBandLabel: { fontSize: "10px", textAlign: "center" },
  historyRow: { display: "flex", gap: "10px", marginBottom: "32px", overflowX: "auto", paddingBottom: "4px" },
  historyChip: { flexShrink: 0, borderRadius: "12px", padding: "12px 16px", textAlign: "center", cursor: "default", minWidth: "60px" },
  ...
  factorIcon: { fontSize: "20px" },
  factorInfo: { flex: 1, minWidth: "140px" },
  factorLabel: { fontSize: "14px", fontWeight: "600", color: "#1A2332" },
  factorDesc: { fontSize: "12px", color: "#8899AA", marginTop: "2px" },
  factorScore: { fontSize: "20px", fontWeight: "700" },
  ...
  tipsIcon: { fontSize: "24px", flexShrink: 0, marginTop: "2px" },
  tipsTitle: { fontSize: "14px", fontWeight: "600", color: "#0E7A5A", marginBottom: "8px" },
  tipsList: { margin: 0, padding: "0 0 0 18px", color: "#2D6A4F", fontSize: "13px", lineHeight: 1.9 },
};
